...
/**
 * Api for the `Heroe` model.
 */
@Injectable()
export class HeroeApi extends BaseLoopBackApi {
   ...
   * <em>
   * (The remote method definition does not provide any description.
   * This usually means the response is a `Heroe` object.)
   * </em>
   */
  public create(data: any = undefined) {
    let method: string = "POST";

    let url: string = this.getPath() + "/Heroes";
    let urlParams: any = {
    };
  ...
  public exists(id: any) {
    ...
    let url: string = this.getPath() + "/Heroes/:id/exists";
    let urlParams: any = {
      id: id
    };
  ...
  public findById(id: any, filter: LoopBackFilterInterface = undefined) {
    ...
    let url: string = this.getPath() + "/Heroes/:id";
    let urlParams: any = {
      id: id
    };
  ...
  public findOne(filter: LoopBackFilterInterface = undefined) {
    ...
    let url: string = this.getPath() + "/Heroes/findOne";
    let urlParams: any = {
    };
  ...
  public updateAll(where: any = undefined, data: any = undefined) {
    ...
    let url: string = this.getPath() + "/Heroes/update";
    let urlParams: any = {
    };
  ...
  public count(where: any = undefined) {
    ...
    let url: string = this.getPath() + "/Heroes/count";
    let urlParams: any = {
    };
  ...
  public createChangeStream(options: any = undefined) {
    ...
    let url: string = this.getPath() + "/Heroes/change-stream";
    let urlParams: any = {
    };
